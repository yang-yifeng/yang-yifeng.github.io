    ...
    handler: () => {
      window.location.href = "/";
        ...
        handler: () => {
          ...
          description: "",
          section: "News",},{id: "projects-prediction-of-ice-floe-drift-in-miz-hyaice-dr",
          title: 'Prediction of ice floe drift in MIZ (HyAIce-Dr)',
        ...
        section: 'Socials',
        handler: () => {
          window.open("mailto:%79%69%66%65%6E%67.%79%61%6E%67.%31%39@%75%63%6C.%61%63.%75%6B", "_blank");
        },
      },{
        id: 'social-linkedin',
        title: 'LinkedIn',
        section: 'Socials',
        handler: () => {
          window.open("https://www.linkedin.com/in/yyf-0a607519b", "_blank");
        },
      },{
        id: 'social-orcid',
        title: 'ORCID',
        section: 'Socials',
        handler: () => {
          window.open("https://orcid.org/0009-0006-6097-1679", "_blank");
        },
      },{
        id: 'social-scholar',
        ...
        section: 'Socials',
        handler: () => {
          window.open("https://scholar.google.com/citations?user=Rf6X9RYAAAAJ", "_blank");
        },
      },{
        id: 'social-work',
        title: 'Work',
        section: 'Socials',
        handler: () => {
          window.open("https://profiles.ucl.ac.uk/73479-yifeng-yang", "_blank");
        },
      },{
      id: 'light-theme',
